              ...
              Align(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    segments: const [
                      ButtonSegment(value: "Wisatawan", label: Text("Wisatawan")),
                      ButtonSegment(value: "Tour Guide", label: Text("Tour Guide")),
                    ],
                    ...
                    style: ButtonStyle(
                      backgroundColor: WidgetStateProperty.resolveWith((states) =>
                        states.contains(WidgetState.selected)
                            ? const Color.fromARGB(255, 0, 27, 41)
                            : Colors.white),
                    ...
                    Align(
                      ...
                      child: TextButton(
                        ...
                        child: const Text(
                          "Lupa password?",
                          style: TextStyle(
                            color: Color.fromARGB(149, 0, 4, 255),
                          ),
                        ),
                      ),
                    ),
                          ...
                          onPressed: () {
                            if (selectedRole == "Wisatawan") {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const FormPendaftaranWisatawan(),
                                ),
                              );
                            } else if (selectedRole == "Tour Guide") {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const FormPendaftaranTourGuide(),
                                ),
                              );
                            }
                          },
