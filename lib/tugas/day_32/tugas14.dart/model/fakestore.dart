...
//
//     final listStore = listStoreFromJson(jsonString);

import 'dart:convert';

List<ListStore> listStoreFromJson(String str) =>
    List<ListStore>.from(json.decode(str).map((x) => ListStore.fromJson(x)));

String listStoreToJson(List<ListStore> data) =>
